...
public class DraggingButton extends AppCompatButton {
    ...
    public DraggingButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DraggingButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
