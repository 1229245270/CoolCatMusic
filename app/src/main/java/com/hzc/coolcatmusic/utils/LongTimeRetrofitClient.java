 ...
 */
public class LongTimeRetrofitClient {
    //超时时间
    ...
    private static class SingletonHolder {
        private static LongTimeRetrofitClient INSTANCE = new LongTimeRetrofitClient();
    }

    public static LongTimeRetrofitClient getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private LongTimeRetrofitClient() {
        this(GlobalData.URL(), null);
    }

    private LongTimeRetrofitClient(String url, Map<String, String> headers) {
...
//                .cache(cache)
                ...
                // 这里你可以根据自己的机型设置同时连接的个数和时间，我这里8个，和每个保持时间为60s
                .build();
